...
#        print(row)
    ...
    for bbox in bbox_id:
        ...
        if id in vh_down:
           ...
           if cy2<(cy+offset) and cy2 > (cy-offset):
             ...
             if counter.count(id)==0: #This line checks if the current object id is not already present in the counter list. 
                counter.append(id) 
                distance = 10 # meters
    ...
    if cv2.waitKey(1)&0xFF==27:  #only 8 bits are allowed
        break
cap.release()
